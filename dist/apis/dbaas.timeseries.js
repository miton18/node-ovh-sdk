...
class DbaasTimeseries {
    ...
    */
     ...
     */
    CreateAOpenTSDBToken(permission, serviceName, tags, description) {
        let url = `/dbaas/timeseries/${serviceName}/token/opentsdb`;
        return this.client.request('POST', url, { permission, tags, description });
    }
    /**
     * Key [BETA]
     * [See on api.ovh.com](https://eu.api.ovh.com/console/#/dbaas/timeseries/%7BserviceName%7D/token/opentsdb/%7BtokenId%7D#GET)
     */
    GetAOpenTSDBToken(serviceName, tokenId) {
     ...
     */
    DeleteAnOpenTSDBToken(serviceName, tokenId) {
        let url = `/dbaas/timeseries/${serviceName}/token/opentsdb/${tokenId}`;
        return this.client.request('DELETE', url);
    }
    /**
...
exports.DbaasTimeseries = DbaasTimeseries;
